...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "D:/CPU/CPU_project/.Xil/Vivado-6964-ZIQIAN/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -sv -include d:/CPU/CPU_project/CPU.srcs/sources_1/ip/clk_wiz_0 D:/Xilinx/Vivado/2018.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv
      rt::read_verilog -include d:/CPU/CPU_project/CPU.srcs/sources_1/ip/clk_wiz_0 {
      D:/CPU/CPU_project/.Xil/Vivado-6964-ZIQIAN/realtime/clk_wiz_0_stub.v
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "D:/CPU/CPU_project/.Xil/Vivado-6964-ZIQIAN/"
